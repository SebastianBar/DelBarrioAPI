exports.seed = function (knex) {
  return knex.raw('DROP FUNCTION IF EXISTS search_posts(varchar)')
    .then(() => {
      return knex.raw(`CREATE OR REPLACE FUNCTION search_posts(que VARCHAR(255))
      RETURNS TABLE ( "IDEN_PUBLICACION" INTEGER, "NOMB_PUBLICACION" VARCHAR(255) ) AS $$
      BEGIN
        RETURN QUERY 
          SELECT pub."IDEN_PUBLICACION",
          pub."NOMB_PUBLICACION"
